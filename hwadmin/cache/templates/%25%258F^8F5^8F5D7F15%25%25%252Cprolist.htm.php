<?php /* Smarty version 2.6.13, created on 2011-12-21 06:32:38
         compiled from %2Cprolist.htm */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'getcategories', ',prolist.htm', 22, false),array('function', 'getitems', ',prolist.htm', 31, false),array('function', 'getindexs', ',prolist.htm', 44, false),)), $this); ?>
        ...
        <tr>
          <td><span class="lan12" style="padding-top:15px;padding-bottom:15px;">
            <table width="100%"  >
             ...
             <?php echo getitems(array('bandindex' => '1','category' => $this->_tpl_vars['category'],'page' => $this->_tpl_vars['page'],'orderby' => 'id_reverse','num' => '9','includesubcategory' => '1','timelimit' => '1','colspan' => '3','overflow' => "</tr><tr>",'template' => "
                <td align=()center() ><table cellpadding=()0() cellspacing=()2() style=()margin-bottom:10px;()>
                    <tr>
                      <td><a class=()a2() href=()[url]()><img height=()200() width=()200() src=()[picture]() border=()0() alt=()[title]()/></a></td>
                    </tr>
                  </table>
                  <a href=()[url]()>[title]</a></td>"), $this);?>
